 ...
 * @author Asus
 */
public class FrontDisplay extends javax.swing.JFrame {

    /**
     * Creates new form FrontDisplay
     */
    public FrontDisplay() {
        initComponents();
        show(position);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrontDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrontDisplay().setVisible(true);
            }
        });
    }
