...
public class Help extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("<html><h1>Our Motive</h1> From dogfighting to fake animal rescue videos and monkey torture, animal cruelty is becoming an increasingly popular form of entertainment. Foster Paradise Team is exposing these cruel and illegal activities through undercover operations and investigative reports. Our team has found hundreds of accounts and thousands of posts on social media platforms that promote animal cruelty, despite these posts being against these platforms’ community standards.<br>  <h1>About Us</h1> Our mission is to create a better world for animals<br> -We end the needless suffering of animals<br> -We influence decision makers to put animals on the global agenda<br> -We help the world see how important animals are to all of us<br> -We inspire people to change animals’ lives for the better<br> -We move the world to protect animals<br>  <h1>Equity, diversity and Inclusion</h1> Foster Paradise believes that our success depends on a culture that values and celebrates equity, diversity and inclusion in our people, to achieve our vision to end cruelty and suffering to animals, forever.  As an equal opportunity employer, we are committed to creating a diverse and inclusive working environment, empowering all our people to achieve their potential. We actively celebrate diversity of our people and while we have some way to go, we are committed to ensuring all our people are heard and feel included. We will not rest until we achieve equity and equality of opportunity for all our people.<br>   </html>");
